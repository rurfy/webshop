            ...
            <tbody>
                ...
                foreach ($_SESSION['cart_item'] as $item) {
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <?= $this->Html->link(__('Entfernen'), ['controller'=>'produkt', 'action' => 'removeFromCart', $item["id"], $produkt->ProduktID]); ?>
                        </td>
                    </tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('Warenkorb löschen'), ['controller'=>'produkt','action' => 'emptyCart', $produkt->ProduktID]); ?>
                </td>
            </tbody>
        </table>
    </div>
